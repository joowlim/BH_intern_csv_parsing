import pymysql, openpyxl, configparser, os, sys
...
sql_column_info = "SELECT column_info_id, column_info FROM COLUMN_INFO"
curs.execute(sql_column_info)
columns = curs.fetchall()

for (column_info_id, column_info) in columns:
